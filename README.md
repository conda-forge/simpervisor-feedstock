...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/simpervisor-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6282&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/simpervisor-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `simpervisor` can be installed with:

```
conda install simpervisor
```

It is possible to list all of the versions of `simpervisor` available on your platform with:
